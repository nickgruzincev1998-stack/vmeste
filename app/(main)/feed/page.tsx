        ...
        <section className="py-24 bg-[#0a0f0a]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 text-center">
              <Link href="/feed" className="inline-flex items-center gap-3 bg-mint text-forest font-unbounded font-bold text-sm px-10 py-4 rounded-2xl hover:bg-mint/90 transition-all hover:scale-105">
