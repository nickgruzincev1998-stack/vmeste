...
/* ---------- floating hero cards ---------- */
const heroCards = [
  { emoji: "🛖", title: "Баня на Серебрянке", time: "Сегодня · 19:00", spots: "2 места", delay: "animate-float-slow" },
  { emoji: "🚴", title: "Велопрогулка по набережной", time: "Суббота · 10:00", spots: "6 мест", delay: "animate-float-medium" },
  { emoji: "⛺", title: "Глэмпинг у Сенежа", time: "Эти выходные", spots: "4 места", delay: "animate-float-fast" },
];
  ...
  return (
    <div className="min-h-screen font-golos">
              ...
              <div className="relative w-[380px] h-[460px]">
                {heroCards.map((card, i) => {
                  ...
                  return (
                    <div
                      key={card.title}
                      className={`absolute ${positions[i]} ${bgs[i]} ${card.delay} rounded-2xl p-5 shadow-2xl min-w-[200px]`}
                    >
      ...
      <section className="py-24 bg-forest">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-4">
            <span className="section-label text-mint">Как это работает</span>
          </div>
      ...
      <section className="py-24 bg-sand">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {MOCK_ACTIVITIES.slice(0, 6).map((a) => (
